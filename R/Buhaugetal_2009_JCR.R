...
#'Variables Y, Y0 and C were later added by \href{http://bit.ly/38eDsnG}{Bagozzi et al. (2019)} for their analysis.
...
#'    \item{sip2l_onset}{sip2l value in onset year.}
#'    \item{pcw}{post cold war period, 1989+.}
#'    \item{frst}{percentage of forest in conflict zone.}
#'    \item{mt}{percentage of mounts in conflict zone.}
